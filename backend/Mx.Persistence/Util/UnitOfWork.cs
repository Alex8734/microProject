using System.Data;
using Mx.Persistence.Repositories;
...
public interface IUnitOfWork
{
    ...
    public IMotorcycleRepository MotorcycleRepository { get; }
    ...
    : IUnitOfWork, ITransactionProvider
{
    ...
    public ITrackRepository TrackRepository => new TrackRepository(context.Tracks);
    public IMotorcycleRepository MotorcycleRepository => new MotorcycleRepository(context.Motorcycles);
